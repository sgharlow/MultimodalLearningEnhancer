...
// Make available in all contexts (window, worker, service worker)
...
if (typeof self !== 'undefined') {
  self.StorageManager = StorageManagerInstance;
}

// Also export with different name for compatibility
if (typeof globalThis !== 'undefined') {
  globalThis.StorageManager = StorageManagerInstance;
}

console.log('[Storage] StorageManager singleton created and exported');
